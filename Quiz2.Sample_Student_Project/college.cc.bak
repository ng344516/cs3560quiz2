...
/*!
* @file college.cc
* @brief This file contains the source code for college functions
* @author Matthew Aberegg
*
* *NOTE* The three documented functions are in this file
*/
#include "college.h"
#include<cstdlib>
#include<iostream>
...
* @param[in] c the course to be added
*/
...
/*!
* @brief removes a selected course from the list
* @param [in] coursename the name of the course to be removed
*
* If the name is not in the list nothing is changed
*/
...
/*!
* @brief calculates and returns GPA
* @return a double
*/
double College::gpa(){
	node * ptr;
